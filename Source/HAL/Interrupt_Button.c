...
/**
 * Function Name: void Handling_Interrupt_Button(uint8_t GPIX_Interrupt_Button, uint8_t GPIO_Pin_X, GPIOModeInterrButton_TypeDef GPIO_Mode_Input, \
                                uint8_t GPIO_PinSourceX, uint8_t EXTI_LineX, EXTITrigger_TypeDef EXTI_Trigger_X, uint8_t EXTIX_IRQn)
 *
...
void Initialize_Button(uint8_t GPIX_Interrupt_Button, uint8_t GPIO_Pin_X, GPIOModeInterrButton_TypeDef GPIO_Mode_Input)
{
  ...
  if(GPIX_Interrupt_Button == GPIOA_Interrupt_Button)
  {
      ...
      GPIO_InitStructure.GPIO_Pin = GPIO_Pin_X; // Pin GPIO 0
...
void Handling_Interrupt_Button(uint8_t GPIX_Interrupt_Button, uint8_t GPIO_Pin_X, GPIOModeInterrButton_TypeDef GPIO_Mode_Input, \
                                uint8_t GPIO_PinSourceX, uint8_t EXTI_LineX, EXTITrigger_TypeDef EXTI_Trigger_X, uint8_t EXTIX_IRQn){

  // Initialization button
  Initialize_Button(GPIX_Interrupt_Button, GPIO_Pin_X, GPIO_Mode_Input);

  // configure GPIOX Pin 0 as a peripheral signal source for a peripheral interrupt channel
